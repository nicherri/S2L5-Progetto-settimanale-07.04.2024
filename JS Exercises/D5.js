...
*/
const petsOrdinato = pets.sort ();

for (let i = 0; i<pets.length; i++  ){
  console.log(petsOrdinato[i]);
}
...
const primoElemento = pets;
 var elementoRimosso= primoElemento.shift ();

 pets.push(elementoRimosso);
...
cars.forEach (cars => {
  cars.licensePlate = generatoredicodici();
})
function generatoredicodici(){
